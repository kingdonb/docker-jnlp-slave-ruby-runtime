FROM yebyen/jenkins-ruby-slave-base:2.6.5
...
RUN set -ex \
        && apt-get update \
        && apt-get install -y libxss1 libappindicator3-1 libindicator7 libgtk-3-0 fonts-liberation xdg-utils gconf-service libgconf-2-4 lsb-release libasound2 libnss3 libnspr4 \
